    ...
    <section className='relative z-0 flex h-full w-full flex-col gap-2 pt-14 lg:pt-18'>
      <div className='-mt-8 flex flex-col-reverse items-center gap-5 lg:mt-0 lg:flex-row lg:justify-between'>
        <div className='text-secondary-500 flex w-full max-w-[630px] flex-1 flex-col gap-3 lg:gap-4'>
          ...
          <div className='mt-4 flex items-center gap-5 pl-1'>
            <div className='relative flex items-center gap-4 [&>*:nth-child(n+2)]:-ml-7 sm:[&>*:nth-child(n+2)]:-ml-8'>
              ...
              />
              <Avatar
                className='hidden aspect-square h-auto w-8 ring sm:block sm:w-[2.625rem] sm:ring-2'
                isBordered
                color='default'
        ...
        <div className='relative mx-auto flex aspect-[517/296] h-full w-full max-w-[517px] flex-1 items-center justify-center'>
          <svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 940.8 578.3' className='h-full w-full scale-[1.2]'>
            <defs>
              <style>{`.result-2_svg__st0{fill:#2c3345}.result-2_svg__st1{stroke-dasharray:8 8;fill:none;stroke-linecap:round;stroke-linejoin:round;stroke:#97b4d9;stroke-width:4px}`}</style>
            </defs>
            <path
              d='M49.4 470.2h840.8'
              style={{
            ...
            ></path>
            <path
              d='M243.8 413.8v56.3M356.8 273.2v197M469.8 110.4v359.7M582.8 273.2v197M695.9 413.8v56.3'
              className='result-2_svg__st1'
            ></path>
            <path
